...
async function seed() {
  ...
  try {
    ...
    await connection.execute(`
      INSERT INTO vehicles (lot_number, year, make, model, description, image_url, current_bid, buy_now_price, location_id, category_id, sale_type, has_warranty, has_report) VALUES
