...
export function SupportPage() {
  return (
    <SimplePage
      ...
      content="Entre em contato conosco através do WhatsApp (11) 92127-1104 ou email contato@copartosasco.com.br. Nossa equipe está pronta para responder suas dúvidas sobre compra, venda, leilões e muito mais."
    />
  );
}
