...
export function SupportPage() {
  return (
    <SimplePage
      ...
      content="Entre em contato conosco através do WhatsApp (11) 95993-9239 ou email contato@copartleilao.com.br. Nossa equipe está pronta para responder suas dúvidas sobre compra, venda, leilões e muito mais."
    />
  );
}
